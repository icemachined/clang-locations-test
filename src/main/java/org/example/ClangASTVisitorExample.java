...
public class ClangASTVisitorExample {
	...
	public static void main(String[] args) throws Exception {
		...
		File file = new File(ClangASTVisitorExample.class.getClassLoader().getResource("main.cpp").toURI());
	...
	protected static class TemplateVisitor extends CXCursorVisitor {
		...
		protected void show_location(CXCursor cursor) {
			...
			String filename = file.isNull()?"null":clang.clang_getFileName(file).getString();
